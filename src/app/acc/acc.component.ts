...
export class AccComponent implements OnInit, AfterViewInit {
  ...
  onSearchWarning(bodySearch: any): Observable<any> {
    return this.http.post<any>('http://localhost:8070/api/admin/get_eventdetail', bodySearch);
  }
  ...
  createTable() {
    ...
    this.columnDefs = [
      ...
      { headerName: 'Người đăng kí', field: 'fullname', cellStyle: this.STYLE_TABLE },
      ...
      { headerName: 'Caption', field: 'caption', cellStyle: this.STYLE_TABLE },
      {
      ...
      { headerName: 'Ngày đăng kí', field: 'register_date', cellStyle: this.STYLE_TABLE },
      { headerName: 'Tên sự kiện', field: 'event_name', cellStyle: this.STYLE_TABLE },
